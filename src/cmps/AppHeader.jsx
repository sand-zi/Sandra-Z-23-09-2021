    ...
    return (
        ...
        ${isDarkMode ? 'dark' : ''} ${isMenuOpen ? 'open' : ''}`}>
            ...
            <div className="toggle-menu-btn" onClick={toggleMenu}>
                <img src={(isDarkMode) ? require('../assets/icons/menu-icon-dark.svg').default : require('../assets/icons/menu-icon.svg').default} alt="color-mode-changer" onClick={onSetColorMode} />
            </div>
            <div className="toggle-menu-screen" onClick={toggleMenu}>
